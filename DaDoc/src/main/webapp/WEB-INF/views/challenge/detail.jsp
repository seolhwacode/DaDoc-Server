...
<body>
				...
				<div class="col-6 col-md-4 col-lg-3">
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							<p>
								<small>현재 인증 횟수는 ${tmp.shotNum}/${tmp.period }</small>
							</p>
						</div>
					</div>
				</div>
				...
				<c:choose>
					<c:when test="${dto.prevNum ne 0 }">
						<li class="page-item mr-3"><a class="page-link"
							href="${pageContext.request.contextPath}/gallery/detail.do?num=${dto.prevNum}">&larr;
								Prev</a></li>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					<c:when test="${dto.nextNum ne 0 }">
						<li class="page-item"><a class="page-link"
							href="${pageContext.request.contextPath}/gallery/detail.do?num=${dto.nextNum}">Next
								&rarr;</a></li>
					</c:when>
					<c:otherwise>
	...
	<button type="button" class="btn btn-primary" data-bs-toggle="modal"
		data-bs-target="#exampleModal">인증샷 업로드</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<a href="javascript:" id="photoLink"> <svg
	...
	<button type="button" id="modalBtn" class="btn btn-primary"
		data-bs-toggle="modal" data-bs-target="#staticBackdrop">챌린지
		신청하기</button>
		...
		<div class="modal-dialog modal-dialog-scrollable">
			<div class="modal-content">
				...
				<div class="modal-body">Lorem ipsum dolor sit amet,
					consectetur adipisicing elit. Ut ipsam voluptate fugiat tenetur
					amet quidem quae fugit aliquid suscipit eos omnis natus
					praesentium. Cupiditate voluptatem voluptas magnam quia molestias
					dignissimos. Lorem ipsum dolor sit amet, consectetur adipisicing
					elit. Obcaecati ullam maiores accusantium eligendi quo explicabo
					sit error dicta! Labore ipsa ut voluptatum eius similique delectus
					quae distinctio. A architecto recusandae? Lorem ipsum dolor sit
					amet, consectetur adipisicing elit. Cum molestias sequi
					consequuntur a vitae omnis quis ipsum eaque possimus inventore esse
					repellendus sit reprehenderit laudantium voluptatem blanditiis
					expedita quasi nemo. Lorem ipsum dolor sit amet, consectetur
					adipisicing elit. Odit praesentium nulla ad quisquam doloremque
					possimus illum deleniti magnam non quaerat sequi quis ut sit veniam
					voluptatum necessitatibus porro iste similique?</div>
				<div class="form-check">
					<input class="form-check-input" type="checkbox" value=""
						id="flexCheckChecked"> <label class="form-check-label"
						for="flexCheckChecked"> 모두 동의합니다. </label>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
