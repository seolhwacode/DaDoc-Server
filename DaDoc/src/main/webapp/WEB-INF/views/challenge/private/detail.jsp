...
<body>
					...
					<c:otherwise>
						<c:if test="${tmp.num eq tmp.comment_group }">
							<li>
								<div class="comment">
									<div class="img-thumbnail img-thumbnail-no-borders d-none d-sm-block">
										<img class="profile-image" alt="" src="${pageContext.request.contextPath}${tmp.profile }">
									</div>
									<div class="comment-block">
										...
										<span class="comment-by">
											...
											<span class="float-right">
												<i class="fas fa-reply" id="reply-icon"><a data-num="${tmp.num }" href="javascript:" class="reply-link">Reply</a></i>
							...
							<div class="comment-form">
								<form id="reForm${tmp.num }" class="contact-form p-4 re-insert-form" action="comment_insert.do" method="post">			
									<div class="form-row">
						...
						<c:if test="${tmp.num ne tmp.comment_group }">					
							<ul class="comments reply">
								...
								<!-- 답 댓글 폼 -->					
									<form id="reForm${tmp.num }" class="comment-form" action="comment_insert.do" method="post">			
										<div class="form-row">
											<div class="form-group col-lg-6">
												<label class="required font-weight-bold text-dark">댓글 작성</label>
												<input type="text" value="" maxlength="200" name="content" id="content">
												<input type="hidden" name="title" value="${dto.title }" />
												<input type="hidden" name="ref_group" value="${dto.num }"/>
												<input type="hidden" name="target_id" value="${tmp.writer }"/>
												<input type="hidden" name="comment_group" value="${tmp.comment_group }"/>
	...
	<div class="post-leave-comment">
		<form id="comment-form" class="comment-form p-4" action="comment_insert.do" method="post">			
			<div class="form-row">
				<div class="form-group col-lg-6">
					<label class="font-weight-bold text-dark">댓글 작성</label>
					<input type="text" value="" maxlength="200" class="form-control" name="content" id="content">
			...
			<div class="form-row">
				<div class="form-group col mb-0">
					<input type="submit" value="등록" class="btn btn-outline btn-rounded btn-quaternary mb-2">
				</div>
			</div>
		</form>
	</div>
