		...
		<section class="page-header page-header-modern page-header-md">
			<div class="container">
				...
				<div class="container">
					...
					<form name="myForm" action="${pageContext.request.contextPath}/challenge/private/update.do" method="post" enctype="multipart/form-data" id="myForm" >
							...
							<div class="col-lg-4">
								...
								<section class=" info-section section-no-border p-5 mt-1 mb-4" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'containerSelector': '.container', 'padding': {'top': 150}}">
									...
									<div class="form-row">
										<div class="form-group col">
											<div class="form-control-custom form-control-datepicker-custom">
												<input type="date" value="" class="form-control text-uppercase text-2" data-msg-required="This field is required." placeholder="시작일" value="${dto.startDate }" name="startDate" id="startDate" required>
											</div>
										</div>
									</div>
									...
									<div class="form-row">
										<div class="form-group col">
											<div class="form-control-custom form-control-datepicker-custom">
												<input type="date" value="" class="form-control text-uppercase text-2" data-msg-required="This field is required." placeholder="종료일" value="${dto.endDate }"name="endDate" id="endDate" required>
											</div>
										</div>
									</div>
									<!-- 카테고리 -->
										...
										<div class="form-group col">
											<div class="form-control-custom">
												<select class="form-control text-uppercase text-2" name="period" id="period" data-msg-required="This field is required." required>
													...
													<option value=8 ${dto.period eq '8' ? 'selected' : '' }>8</option>
													<option value=9 ${dto.period eq '9' ? 'selected' : '' }>9</option>
													<option value=10 ${dto.period eq '10' ? 'selected' : '' }>10</option>
												</select>
											</div>
										</div>
									</div>
							...
							<div class="col-lg-8">
								...
								<section class="section section-quaternary section-no-border text-light p-5 mt-1 mb-4">
									...
									<div class="row">
										<div class="col-1 text-center">
											<label class="mt-4 mb-4">
												<input type="radio" checked="${dto.category eq 'reading' ? 'checked' : '' }" name="category" id="category" value="reading">
											</label>
										</div>
									...
									<div class="row">
										<div class="col-1 text-center">
											<label class="mt-4 mb-4">
												<input type="radio" checked="${dto.category eq 'writing' ? 'checked' : '' }" name="category" id="category" value="writing">
											</label>
										</div>
										<div class="col-2 d-none d-sm-block">
									...
									<div class="row">
										<div class="col-1 text-center">
											<label class="mt-4 mb-4">
												<input type="radio" checked="${dto.category eq 'listening' ? 'checked' : '' }" name="category" id="category" value="listening">
											</label>
										</div>
										<div class="col-2 d-none d-sm-block">
								...
								<section class="section section-quaternary section-no-border text-light p-5 mt-1 mb-4">
									...
									<input type="hidden" name="image" id="image" value="${dto.image }" accept=".jpg, .jpeg, .png, .JPG, .JPEG"/>	
									
									<div class="form-row">
										<div class="form-group col">
											<label for="title" class="form-control-label">챌린지 제목</label>
											<input type="text" class="form-control" value="${dto.title }" id="title" name="title" placeholder="제목을 입력하세요...">
										</div>	
									</div>
									...
									<div class="form-row">
										<div class="form-group col">
											...
											<input type="text" class="form-control" value=${dto.description } id="description" name="description" placeholder="설명을 입력하세요...">
										</div>				
									</div>	
...
<script>
	...
	//날짜 값 담아주기
	document.querySelector("#startDate").value="${dto.startDate}";
	document.querySelector("#endDate").value="${dto.endDate}";
	//프로필 이미지 링크를 클릭하면
